<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Clock in and clock out for your assigned company.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="pt-3">
                @if($today && $today->status->value === 'checked_in')
                <button type="button" wire:click="checkOut" class="w-full bg-white border border-emerald-600 text-emerald-700 text-sm font-medium px-4 py-3 hover:bg-emerald-50 transition flex items-center justify-center gap-2">
                ...
                @else
                <button type="button" wire:click="checkIn" class="w-full bg-emerald-600 text-white text-sm font-medium px-4 py-3 hover:bg-emerald-700 transition flex items-center justify-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
                        <circle cx="12" cy="12" r="9"/>
